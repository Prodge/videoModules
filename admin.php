<body style="width:60%; margin-right:auto; margin-left:auto;">
    <?php
        ...
        $username = "admin";
        $password = "admin";
        $nonsense = "thaosentmmnkwmnseutomsnotu";

        if (isset($_COOKIE['PrivateLogin'])) {
           if ($_COOKIE['PrivateLogin'] == md5($password.$nonsense)) {
        ...
        if (isset($_GET['p']) && $_GET['p'] == "login") {
            if ($_POST['user'] != $username) {
                ...
                setcookie('PrivateLogin', md5($_POST['keypass'].$nonsense, time() + (86400 * 3), "/"));//cookie is valid for 3 days
